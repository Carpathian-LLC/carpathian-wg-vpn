...
# ------------------------------------------------------------------------------------
# File: macos/connect.py
# ------------------------------------------------------------------------------------
# Notes:
# - Lightweight WireGuard TUI for macOS.
# - Usage: sudo python3 connect.py [config_name]
# - Configs are auto-discovered from ../configs/*.conf
# - Supports Homebrew and MacPorts installs of wireguard-tools.
# ------------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------------
# Binary discovery (Homebrew + MacPorts)
# ------------------------------------------------------------------------------------
...
def find_binaries():
    for p in PREFIXES:
        wg, wgq = f"{p}/bin/wg", f"{p}/bin/wg-quick"
...
def main():
    ...
    cafe = subprocess.Popen(["caffeinate", "-i"])
    try:
